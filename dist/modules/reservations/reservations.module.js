...
exports.ReservationsModule = ReservationsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([reservation_entity_1.Reservation, event_sector_entity_1.EventSector, stock_movement_entity_1.StockMovement]), realtime_module_1.RealtimeModule],
        controllers: [reservations_controller_1.ReservationsController],
        providers: [reservations_service_1.ReservationsService],
        exports: [reservations_service_1.ReservationsService, typeorm_1.TypeOrmModule]
    })
], ReservationsModule);
